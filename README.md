...
1. [x] [1. Introduction](https://github.com/c4arl0s/13-testing-the-user-interface#1-Introduction)
...
5. [x] [5. UI Test Classes](https://github.com/c4arl0s/13-testing-the-user-interface#5-UI-Test-Classes)
...
8. [x] [8. XCUIApplication](https://github.com/c4arl0s/13-testing-the-user-interface#8-XCUIApplication)
9. [x] [9. XCUIDevice](https://github.com/c4arl0s/13-testing-the-user-interface#9-XCUIDevice)
10. [x] [10. XCUIElementAttributes](https://github.com/c4arl0s/13-testing-the-user-interface#10-XCUIElementAttributes)
